...
echo -e "\e[34m-->> Configuring the erlang repository. \e[0m" | tee -a ${log}
curl -s https://packagecloud.io/install/repositories/rabbitmq/erlang/script.rpm.sh | bash  &>> ${log}
func_exit_status

# Configure YUM Repos for RabbitMQ.
echo -e "\e[34m-->> Configuring the RabbitMQ repository. \e[0m" | tee -a ${log}
curl -s https://packagecloud.io/install/repositories/rabbitmq/rabbitmq-server/script.rpm.sh | bash  &>> ${log}
func_exit_status

# Install RabbitMQ
echo -e "\e[34m-->> Installing the rabbitmq-server package. \e[0m" | tee -a ${log}
...
echo -e "\e[34m-->> Configuring the RabbitMQ User/Pass . \e[0m" | tee -a ${log}
