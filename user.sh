...
echo -e "\e[34mDeleting The existing  /etc/systemd/system/user.service file.\e[0m" | tee -a ${log}
rm -rf /etc/systemd/system/user.service &>> ${log}

echo -e "\e[34mCopying The user.service to /etc/systemd/system/user.service.\e[0m" | tee -a ${log}
...
echo -e "\e[34mStarting & Enabling the user service.\e[0m" | tee -a ${log}
...
mongo --host mongodb.learntechnology.tech </app/schema/user.js  &>> ${log}
...
#exec bash
# Restart the service.
echo -e "\e[34mRestarting the user service.\e[0m" | tee -a ${log}
