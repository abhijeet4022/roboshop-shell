...
echo -e "\e[32mConfiguraing the repo for NodeJS\e[0m"
curl -sL https://rpm.nodesource.com/setup_lts.x | bash

echo -e "\e[32mInstalling NodeJS & bash-completion\e[0m"
...
echo -e "\e[32mStart & Enable the catalogue service\e[0m"
...
echo -e "\e[32mInstalling the mongodb-org-shell\e[0m"
dnf install mongodb-org-shell -y

#Load Schema
echo -e "\e[32mLoad the mongodb schema\e[0m"
