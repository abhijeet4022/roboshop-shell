...
echo -e "\e[34mDeleting The existing  /etc/systemd/system/catalogue.service file.\e[0m"
rm -rf /etc/systemd/system/catalogue.service &>> /tmp/roboshop.log

echo -e "\e[34mCopying The Catalogue.service to /etc/systemd/system/catalogue.service.\e[0m"
...
echo -e "\e[34mConfiguring the repo for NodeJS.\e[0m"
curl -sL https://rpm.nodesource.com/setup_lts.x | bash  &>> /tmp/roboshop.log

echo -e "\e[34mInstalling NodeJS & bash-completion package.\e[0m"
yum install -y bash-completion nodejs  &>> /tmp/roboshop.log

# Setup an app directory.
echo -e "\e[34mRemoving the existing /app directory.\e[0m"
rm -rf /app &>> /tmp/roboshop.log

echo -e "\e[34mCreating Application Directory- /app.\e[0m"
mkdir /app  &>> /tmp/roboshop.log

# Download the application code to created app directory.
echo -e "\e[34mDownloading the Application code.\e[0m"
curl -o /tmp/catalogue.zip https://roboshop-artifacts.s3.amazonaws.com/catalogue.zip &>> /tmp/roboshop.log

echo -e "\e[34mExtracting the Application code.\e[0m"
...
echo -e "\e[34mConfiguring the repo for mongodb.\e[0m"
cp mongo.repo /etc/yum.repos.d/mongo.repo  &>> /tmp/roboshop.log

echo -e "\e[34mInstalling the mongodb-org-shell package.\e[0m"
dnf install mongodb-org-shell -y  &>> /tmp/roboshop.log

#Load Schema
echo -e "\e[34mLoading the mongodb schema.\e[0m"
